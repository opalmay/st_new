...
// static char *font2[] = { "mononoki Nerd Font Mono:pixelsize=18:antialias=true:autohint=true" };

static char *font = "JetBrainsMono Nerd Font Mono:pixelsize=18:antialias=true:autohint=true";
static char *font2[] = { "JetBrainsMono Nerd Font Mono:pixelsize=18:antialias=true:autohint=true" };
